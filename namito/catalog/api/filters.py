...
class ProductFilter(django_filters.FilterSet):
    ...
    color = django_filters.CharFilter(field_name="variants__color__name", lookup_expr='iexact', choices=[])
    size = django_filters.CharFilter(field_name="variants__size__name", lookup_expr='iexact', choices=[])
    brand = django_filters.CharFilter(field_name="brand__name", lookup_expr='iexact', choices=[])
    category = django_filters.CharFilter(field_name="category__name", lookup_expr='iexact', choices=[])
